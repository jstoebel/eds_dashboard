...
class MoodleProcessorJobTest < ActiveJob::TestCase
  ##
  # BIG NOTE!
  # this code was copy pased from  test student_score model test
  # it won't work as written here but reflects the ideas that need to be ported over.
