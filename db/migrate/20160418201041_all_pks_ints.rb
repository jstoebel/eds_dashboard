class AllPksInts < ActiveRecord::Migration
  def up
    ...
    #for each of these tables:
        #drop the fk pointing to students
        #create a new fk to point to new students id
    
    #adm_st
    remove_foreign_key :adm_st, :name => "fk_AdmST_Student"
    change_column :adm_st, :Student_Bnum, :integer
    add_foreign_key :adm_st, :students, :column => "Student_Bnum"

    #adm_tep
    remove_foreign_key :adm_tep, :name => "fk_AdmTEP_Student"
    change_column :adm_tep, :Student_Bnum, :integer
    add_foreign_key :adm_tep, :students, :column => "Student_Bnum" 

    # advisor_assignments -> covered below

    # clinical_assignments
    remove_foreign_key :clinical_assignments, :name => "fk_ClinicalAssignments_Student"
    change_column :clinical_assignments, :Student_Bnum, :integer
    add_foreign_key :clinical_assignments, :students, :column => "Student_Bnum"

    # employment
    remove_foreign_key :employment, :name => "fk_Employment_Student"
    change_column :employment, :Student_Bnum, :integer
    add_foreign_key :employment, :students, :column => "Student_Bnum"
  ...
  #       t.integer :tep_advisor_id
    ...
    # add_foreign_key :advisor_assignments, :students, :column => :Student_Bnum
    # add_foreign_key :advisor_assignments, :tep_advisors, :column => :tep_advisors_AdvisorBnum
  ...
  def down
    ...
    remove_foreign_key :advisor_assignments, :column => "Student_Bnum"
    remove_foreign_key :advisor_assignments, :column => "tep_advisors_AdvisorBnum"
    ...
    remove_foreign_key :employment, :column => "Student_Bnum"
    change_column :employment, :Student_Bnum, :string
    add_foreign_key "employment", "students", name: "fk_Employment_Student", column: "Student_Bnum", primary_key: "Bnum"

    remove_foreign_key :clinical_assignments, :column => "Student_Bnum"
    change_column :clinical_assignments, :Student_Bnum, :string
    add_foreign_key "clinical_assignments", "students", name: "fk_ClinicalAssignments_Student", column: "Bnum", primary_key: "Bnum"

    remove_foreign_key :adm_tep, :column => "Student_Bnum"
    change_column :adm_tep, :Student_Bnum, :string
    add_foreign_key "adm_tep", "students", name: "fk_AdmTEP_Student", column: "Student_Bnum", primary_key: "Bnum"

    remove_foreign_key :adm_st, :column => "Student_Bnum"
    change_column :adm_st, :students, :string
