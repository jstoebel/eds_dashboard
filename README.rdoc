...
* Database creation
	...
	Disidentified data in development db on production server:
		use a python script to migrate all data, but disidentify.
...
* How to run the test suite
	...
	to create the test database:
		...
		1) Make sure the test schema is up to date by syncing with workbench
		2) To ensure test fixtures are up to date:
